...
/**
 * The {@link FlumeWaterMonitorHandlerFactory} is responsible for creating things and thing
 * handlers.
 *
...
public class FlumeWaterMonitorHandlerFactory extends BaseThingHandlerFactory {
    ...
    protected @Nullable ThingHandler createHandler(Thing thing) {
        ...
        if (THING_TYPE_SAMPLE.equals(thingTypeUID)) {
            return new FlumeWaterMonitorHandler(thing);
        }
